...
#ifndef __match_hw_mul_10s_dEe__HH__
#define __match_hw_mul_10s_dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(match_hw_mul_10s_dEe) {
    ...
    SC_CTOR(match_hw_mul_10s_dEe):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
