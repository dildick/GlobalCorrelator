...
#ifndef __match_hw_sitodp_3cud__HH__
#define __match_hw_sitodp_3cud__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(match_hw_sitodp_3cud) {
    ...
    SC_CTOR(match_hw_sitodp_3cud):  ACMP_sitodp_U ("ACMP_sitodp_U") {
