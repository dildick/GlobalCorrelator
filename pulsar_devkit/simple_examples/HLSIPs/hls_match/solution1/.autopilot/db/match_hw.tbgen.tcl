set C_TypeInfoList {{ 
"match_hw" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"inTrack": [[], {"reference": "0"}] }, {"inMuon": [[], {"reference": "1"}] }, {"outTrackMuon": [[], {"reference": "2"}] }],[],""], 
...
"8": [ "quality_m", {"typedef": [[[],"10"],""]}], 
"3": [ "pt_t", {"typedef": [[[],"11"],""]}], 
"11": [ "ap_uint<14>", {"hls_type": {"ap_uint": [[[[], {"scalar": { "int": 14}}]],""]}}], 
"10": [ "ap_uint<4>", {"hls_type": {"ap_uint": [[[[], {"scalar": { "int": 4}}]],""]}}], 
"6": [ "q_t", {"typedef": [[[],"12"],""]}], 
"12": [ "ap_uint<1>", {"hls_type": {"ap_uint": [[[[], {"scalar": { "int": 1}}]],""]}}], 
"1": [ "HwMuon", {"struct": [[],[],[{ "hwPt": [[16], "13"]},{ "hwEta": [[16], "4"]},{ "hwPhi": [[16], "5"]},{ "hwQ": [[8], "6"]},{ "hwValid": [[8], "6"]},{ "hwBX": [[8], "7"]},{ "hwQuality": [[8], "8"]}],""]}], 
"7": [ "bx_t", {"typedef": [[[],"14"],""]}], 
"14": [ "ap_int<3>", {"hls_type": {"ap_int": [[[[], {"scalar": { "int": 3}}]],""]}}], 
"0": [ "HwTrack", {"struct": [[],[],[{ "hwRinv": [[16], "15"]},{ "hwPt": [[16], "3"]},{ "hwSinhEta": [[16], "16"]},{ "hwEta": [[16], "16"]},{ "hwPhi": [[32], "17"]},{ "hwPhiGlobal": [[32], "18"]},{ "hwZ0": [[16], "19"]},{ "hwSector": [[8], "20"]},{ "hwQ": [[8], "6"]},{ "hwX2": [[16], "21"]},{ "hwValid": [[8], "6"]},{ "hwBX": [[8], "7"]}],""]}], 
"16": [ "eta_t", {"typedef": [[[],"22"],""]}], 
"22": [ "ap_int<14>", {"hls_type": {"ap_int": [[[[], {"scalar": { "int": 14}}]],""]}}], 
"17": [ "phi_t", {"typedef": [[[],"23"],""]}], 
"23": [ "ap_int<19>", {"hls_type": {"ap_int": [[[[], {"scalar": { "int": 19}}]],""]}}], 
"21": [ "chisq_t", {"typedef": [[[],"24"],""]}], 
"18": [ "phiglobal_t", {"typedef": [[[],"25"],""]}], 
"25": [ "ap_int<23>", {"hls_type": {"ap_int": [[[[], {"scalar": { "int": 23}}]],""]}}], 
"19": [ "z0_t", {"typedef": [[[],"26"],""]}], 
"26": [ "ap_int<11>", {"hls_type": {"ap_int": [[[[], {"scalar": { "int": 11}}]],""]}}], 
"20": [ "sector_t", {"typedef": [[[],"27"],""]}], 
"27": [ "ap_uint<5>", {"hls_type": {"ap_uint": [[[[], {"scalar": { "int": 5}}]],""]}}], 
"24": [ "ap_int<10>", {"hls_type": {"ap_int": [[[[], {"scalar": { "int": 10}}]],""]}}], 
"4": [ "eta_m", {"typedef": [[[],"28"],""]}], 
"28": [ "ap_int<9>", {"hls_type": {"ap_int": [[[[], {"scalar": { "int": 9}}]],""]}}], 
"13": [ "pt_m", {"typedef": [[[],"29"],""]}], 
"29": [ "ap_uint<9>", {"hls_type": {"ap_uint": [[[[], {"scalar": { "int": 9}}]],""]}}], 
"15": [ "invpt_t", {"typedef": [[[],"30"],""]}], 
"30": [ "ap_int<15>", {"hls_type": {"ap_int": [[[[], {"scalar": { "int": 15}}]],""]}}]
}}
set moduleName match_hw
...
set C_modelArgList {
	...
	{ inTrack_hwEta_V int 14 regular {pointer 0}  }
...
set portList { 
	...
	{ inMuon_hwPt_V sc_in sc_lv 9 signal 12 } 
	{ inMuon_hwEta_V sc_in sc_lv 9 signal 13 } 
	{ inMuon_hwPhi_V sc_in sc_lv 10 signal 14 } 
	{ inMuon_hwQ_V sc_in sc_lv 1 signal 15 } 
	{ inMuon_hwValid_V sc_in sc_lv 1 signal 16 } 
	{ inMuon_hwBX_V sc_in sc_lv 3 signal 17 } 
	{ inMuon_hwQuality_V sc_in sc_lv 4 signal 18 } 
	{ outTrackMuon_hwPt_V sc_out sc_lv 14 signal 19 } 
	{ outTrackMuon_hwPt_V_ap_vld sc_out sc_logic 1 outvld 19 } 
	{ outTrackMuon_hwEta_V sc_out sc_lv 9 signal 20 } 
	{ outTrackMuon_hwEta_V_ap_vld sc_out sc_logic 1 outvld 20 } 
	{ outTrackMuon_hwPhi_V sc_out sc_lv 10 signal 21 } 
	{ outTrackMuon_hwPhi_V_ap_vld sc_out sc_logic 1 outvld 21 } 
	{ outTrackMuon_hwQ_V sc_out sc_lv 1 signal 22 } 
	{ outTrackMuon_hwQ_V_ap_vld sc_out sc_logic 1 outvld 22 } 
	{ outTrackMuon_hwValid_V sc_out sc_lv 1 signal 23 } 
	{ outTrackMuon_hwValid_V_ap_vld sc_out sc_logic 1 outvld 23 } 
	{ outTrackMuon_hwBX_V sc_out sc_lv 3 signal 24 } 
	{ outTrackMuon_hwBX_V_ap_vld sc_out sc_logic 1 outvld 24 } 
	{ outTrackMuon_hwQuality_V sc_in sc_lv 4 signal 25 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.match_hw_dmul_64nbkb_U1", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.match_hw_dmul_64nbkb_U2", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.match_hw_sitodp_3cud_U3", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.match_hw_sitodp_3cud_U4", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.match_hw_mul_10s_dEe_U5", "Parent" : "0"}]}
