...
#ifndef __delta_LUT_mul_mulcud__HH__
#define __delta_LUT_mul_mulcud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(delta_LUT_mul_mulcud) {
    ...
    SC_CTOR(delta_LUT_mul_mulcud):  ACMP_mul_us_U ("ACMP_mul_us_U") {
