...
#include "delta_LUT_mul_mulcud.h"
#include "delta_LUT_delta_tbkb.h"
...
struct delta_LUT : public sc_module {
    ...
    delta_LUT_delta_tbkb* delta_table1_U;
    delta_LUT_mul_mulcud<1,3,13,11,24>* delta_LUT_mul_mulcud_U1;
    ...
    sc_signal< sc_lv<10> > delta_table1_address0;
    sc_signal< sc_logic > delta_table1_ce0;
    sc_signal< sc_lv<11> > delta_table1_q0;
    ...
    sc_signal< sc_lv<11> > sel_tmp_fu_223_p3;
    sc_signal< sc_lv<11> > storemerge1_fu_236_p3;
    ...
    void thread_delta_table1_address0();
    void thread_delta_table1_ce0();
