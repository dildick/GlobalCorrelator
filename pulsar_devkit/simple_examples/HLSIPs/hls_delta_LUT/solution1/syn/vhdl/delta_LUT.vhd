...
port (
    ...
    res_V : OUT STD_LOGIC_VECTOR (18 downto 0);
...
architecture behav of delta_LUT is 
    ...
    "delta_LUT,hls_ip_2016_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7vx690tffg1927-2,HLS_INPUT_CLOCK=4.115000,HLS_INPUT_ARCH=pipeline,HLS_SYN_CLOCK=3.370000,HLS_SYN_LAT=6,HLS_SYN_TPT=1,HLS_SYN_MEM=1,HLS_SYN_DSP=1,HLS_SYN_FF=72,HLS_SYN_LUT=91}";
    ...
    signal delta_table1_address0 : STD_LOGIC_VECTOR (9 downto 0);
    signal delta_table1_ce0 : STD_LOGIC;
    signal delta_table1_q0 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal sel_tmp_fu_223_p3 : STD_LOGIC_VECTOR (10 downto 0);
    signal storemerge1_fu_236_p3 : STD_LOGIC_VECTOR (10 downto 0);
    signal grp_fu_249_p0 : STD_LOGIC_VECTOR (12 downto 0);
    signal ap_NS_fsm : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_pipeline_idle_pp0 : STD_LOGIC;

    component delta_LUT_mul_mulcud IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component delta_LUT_delta_tbkb IS
    generic (
        DataWidth : INTEGER;
...
begin
    delta_table1_U : component delta_LUT_delta_tbkb
    generic map (
        DataWidth => 11,
        AddressRange => 1024,
        AddressWidth => 10)
    port map (
        clk => ap_clk,
        reset => ap_rst,
        address0 => delta_table1_address0,
        ce0 => delta_table1_ce0,
        q0 => delta_table1_q0);

    delta_LUT_mul_mulcud_U1 : component delta_LUT_mul_mulcud
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 13,
    ...
    delta_table1_address0 <= tmp_3_fu_208_p1(10 - 1 downto 0);

    delta_table1_ce0_assign_proc : process(ap_start, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter5)
    begin
    ...
    res_V <= std_logic_vector(resize(unsigned(storemerge1_fu_236_p3),19));
    ...
    sel_tmp_fu_223_p3 <= 
        ap_const_lv11_0 when (sel_tmp2_fu_218_p2(0) = '1') else 
        ap_const_lv11_483;
