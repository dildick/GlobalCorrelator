...
#ifndef __calc_phi_hw_am_adfYi__HH__
#define __calc_phi_hw_am_adfYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(calc_phi_hw_am_adfYi) {
    ...
    SC_CTOR(calc_phi_hw_am_adfYi):  simcore_am_0_U ("simcore_am_0_U") {
