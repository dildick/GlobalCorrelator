...
entity delta_plus_LUT_dehbi_rom is 
    generic(
             dwidth     : integer := 5; 
             awidth     : integer := 10; 
...
architecture rtl of delta_plus_LUT_dehbi_rom is 
...
entity delta_plus_LUT_dehbi is
    generic (
        DataWidth : INTEGER := 5;
...
architecture arch of delta_plus_LUT_dehbi is
    component delta_plus_LUT_dehbi_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    delta_plus_LUT_dehbi_rom_U :  component delta_plus_LUT_dehbi_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
