...
#ifndef __prop_hw_mul_19ns_vdy__HH__
#define __prop_hw_mul_19ns_vdy__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(prop_hw_mul_19ns_vdy) {
    ...
    SC_CTOR(prop_hw_mul_19ns_vdy):  ACMP_mul_us_U ("ACMP_mul_us_U") {
