...
#ifndef __prop_hw_mul_mul_1zec__HH__
#define __prop_hw_mul_mul_1zec__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(prop_hw_mul_mul_1zec) {
    ...
    SC_CTOR(prop_hw_mul_mul_1zec):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
