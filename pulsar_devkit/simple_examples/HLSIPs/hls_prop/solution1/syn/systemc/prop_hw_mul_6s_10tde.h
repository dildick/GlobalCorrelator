...
#ifndef __prop_hw_mul_6s_10tde__HH__
#define __prop_hw_mul_6s_10tde__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(prop_hw_mul_6s_10tde) {
    ...
    SC_CTOR(prop_hw_mul_6s_10tde):  ACMP_mul_su_U ("ACMP_mul_su_U") {
