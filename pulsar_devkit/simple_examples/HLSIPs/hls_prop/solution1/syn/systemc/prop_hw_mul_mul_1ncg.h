...
#ifndef __prop_hw_mul_mul_1ncg__HH__
#define __prop_hw_mul_mul_1ncg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(prop_hw_mul_mul_1ncg) {
    ...
    SC_CTOR(prop_hw_mul_mul_1ncg):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
