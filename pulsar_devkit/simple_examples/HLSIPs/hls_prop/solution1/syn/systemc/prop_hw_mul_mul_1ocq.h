...
#ifndef __prop_hw_mul_mul_1ocq__HH__
#define __prop_hw_mul_mul_1ocq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(prop_hw_mul_mul_1ocq) {
    ...
    SC_CTOR(prop_hw_mul_mul_1ocq):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
