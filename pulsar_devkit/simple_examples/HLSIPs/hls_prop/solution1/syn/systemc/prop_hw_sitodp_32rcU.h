...
#ifndef __prop_hw_sitodp_32rcU__HH__
#define __prop_hw_sitodp_32rcU__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(prop_hw_sitodp_32rcU) {
    ...
    SC_CTOR(prop_hw_sitodp_32rcU):  ACMP_sitodp_U ("ACMP_sitodp_U") {
