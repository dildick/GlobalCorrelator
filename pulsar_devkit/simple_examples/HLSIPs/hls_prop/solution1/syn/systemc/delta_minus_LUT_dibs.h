...
#ifndef __delta_minus_LUT_dibs_H__
#define __delta_minus_LUT_dibs_H__
...
struct delta_minus_LUT_dibs_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(delta_minus_LUT_dibs_ram) {
...
SC_MODULE(delta_minus_LUT_dibs) {
...
delta_minus_LUT_dibs_ram* meminst;


SC_CTOR(delta_minus_LUT_dibs) {
meminst = new delta_minus_LUT_dibs_ram("delta_minus_LUT_dibs_ram");
