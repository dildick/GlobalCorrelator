...
#ifndef __prop_hw_mul_mul_1Aem__HH__
#define __prop_hw_mul_mul_1Aem__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(prop_hw_mul_mul_1Aem) {
    ...
    SC_CTOR(prop_hw_mul_mul_1Aem):  ACMP_mul_su_U ("ACMP_mul_su_U") {
