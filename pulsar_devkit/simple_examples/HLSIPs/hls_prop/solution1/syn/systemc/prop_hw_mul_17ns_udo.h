...
#ifndef __prop_hw_mul_17ns_udo__HH__
#define __prop_hw_mul_17ns_udo__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(prop_hw_mul_17ns_udo) {
    ...
    SC_CTOR(prop_hw_mul_17ns_udo):  ACMP_mul_us_U ("ACMP_mul_us_U") {
