...
#ifndef __delta_plus_LUT_dehbi_H__
#define __delta_plus_LUT_dehbi_H__
...
struct delta_plus_LUT_dehbi_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(delta_plus_LUT_dehbi_ram) {
...
SC_MODULE(delta_plus_LUT_dehbi) {
...
delta_plus_LUT_dehbi_ram* meminst;


SC_CTOR(delta_plus_LUT_dehbi) {
meminst = new delta_plus_LUT_dehbi_ram("delta_plus_LUT_dehbi_ram");
