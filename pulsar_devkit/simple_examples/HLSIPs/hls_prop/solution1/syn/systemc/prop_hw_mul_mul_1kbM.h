...
#ifndef __prop_hw_mul_mul_1kbM__HH__
#define __prop_hw_mul_mul_1kbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(prop_hw_mul_mul_1kbM) {
    ...
    SC_CTOR(prop_hw_mul_mul_1kbM):  ACMP_mul_us_U ("ACMP_mul_us_U") {
