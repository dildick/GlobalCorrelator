...
#ifndef __prop_hw_mul_mul_6xdS__HH__
#define __prop_hw_mul_mul_6xdS__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(prop_hw_mul_mul_6xdS) {
    ...
    SC_CTOR(prop_hw_mul_mul_6xdS):  ACMP_mul_su_U ("ACMP_mul_su_U") {
