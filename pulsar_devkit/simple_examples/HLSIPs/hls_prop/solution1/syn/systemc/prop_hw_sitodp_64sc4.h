...
#ifndef __prop_hw_sitodp_64sc4__HH__
#define __prop_hw_sitodp_64sc4__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(prop_hw_sitodp_64sc4) {
    ...
    SC_CTOR(prop_hw_sitodp_64sc4):  ACMP_sitodp_U ("ACMP_sitodp_U") {
