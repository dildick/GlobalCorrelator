...
#ifndef __prop_hw_am_addmulwdI__HH__
#define __prop_hw_am_addmulwdI__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(prop_hw_am_addmulwdI) {
    ...
    SC_CTOR(prop_hw_am_addmulwdI):  simcore_am_0_U ("simcore_am_0_U") {
