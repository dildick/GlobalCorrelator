...
#ifndef __prop_hw_mac_muladeOg__HH__
#define __prop_hw_mac_muladeOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(prop_hw_mac_muladeOg) {
    ...
    SC_CTOR(prop_hw_mac_muladeOg):  simcore_mac_0_U ("simcore_mac_0_U") {
