...
architecture behav of delta_minus_LUT is 
    ...
    "delta_minus_LUT,hls_ip_2016_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7vx690tffg1927-2,HLS_INPUT_CLOCK=4.115000,HLS_INPUT_ARCH=pipeline,HLS_SYN_CLOCK=3.370000,HLS_SYN_LAT=6,HLS_SYN_TPT=1,HLS_SYN_MEM=1,HLS_SYN_DSP=1,HLS_SYN_FF=72,HLS_SYN_LUT=79}";
    ...
    signal delta_minus_table1_address0 : STD_LOGIC_VECTOR (9 downto 0);
    signal delta_minus_table1_ce0 : STD_LOGIC;
    signal delta_minus_table1_q0 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    component delta_minus_LUT_mcud IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component delta_minus_LUT_dbkb IS
    generic (
        DataWidth : INTEGER;
...
begin
    delta_minus_table1_U : component delta_minus_LUT_dbkb
    generic map (
        DataWidth => 5,
        AddressRange => 1024,
        AddressWidth => 10)
    port map (
        clk => ap_clk,
        reset => ap_rst,
        address0 => delta_minus_table1_address0,
        ce0 => delta_minus_table1_ce0,
        q0 => delta_minus_table1_q0);

    delta_minus_LUT_mcud_U1 : component delta_minus_LUT_mcud
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 13,
    ...
    delta_minus_table1_address0 <= tmp_3_fu_208_p1(10 - 1 downto 0);

    delta_minus_table1_ce0_assign_proc : process(ap_start, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter5)
    begin
