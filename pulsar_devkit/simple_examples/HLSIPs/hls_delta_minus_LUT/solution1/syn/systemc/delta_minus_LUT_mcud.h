...
#ifndef __delta_minus_LUT_mcud__HH__
#define __delta_minus_LUT_mcud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(delta_minus_LUT_mcud) {
    ...
    SC_CTOR(delta_minus_LUT_mcud):  ACMP_mul_us_U ("ACMP_mul_us_U") {
