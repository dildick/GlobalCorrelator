...
#ifndef __calc_eta_hw_sitodfYi__HH__
#define __calc_eta_hw_sitodfYi__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(calc_eta_hw_sitodfYi) {
    ...
    SC_CTOR(calc_eta_hw_sitodfYi):  ACMP_sitodp_U ("ACMP_sitodp_U") {
