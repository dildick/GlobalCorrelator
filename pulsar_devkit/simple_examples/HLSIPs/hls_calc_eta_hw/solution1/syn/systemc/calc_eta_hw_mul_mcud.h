...
#ifndef __calc_eta_hw_mul_mcud__HH__
#define __calc_eta_hw_mul_mcud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(calc_eta_hw_mul_mcud) {
    ...
    SC_CTOR(calc_eta_hw_mul_mcud):  ACMP_mul_us_U ("ACMP_mul_us_U") {
