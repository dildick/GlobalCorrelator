...
#ifndef __calc_eta_hw_sitodeOg__HH__
#define __calc_eta_hw_sitodeOg__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(calc_eta_hw_sitodeOg) {
    ...
    SC_CTOR(calc_eta_hw_sitodeOg):  ACMP_sitodp_U ("ACMP_sitodp_U") {
