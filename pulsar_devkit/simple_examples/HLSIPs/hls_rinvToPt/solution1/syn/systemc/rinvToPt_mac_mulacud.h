...
#ifndef __rinvToPt_mac_mulacud__HH__
#define __rinvToPt_mac_mulacud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(rinvToPt_mac_mulacud) {
    ...
    SC_CTOR(rinvToPt_mac_mulacud):  simcore_mac_0_U ("simcore_mac_0_U") {
