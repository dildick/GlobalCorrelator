...
#ifndef __rinvToInvPt_mac_mcud__HH__
#define __rinvToInvPt_mac_mcud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(rinvToInvPt_mac_mcud) {
    ...
    SC_CTOR(rinvToInvPt_mac_mcud):  simcore_mac_0_U ("simcore_mac_0_U") {
