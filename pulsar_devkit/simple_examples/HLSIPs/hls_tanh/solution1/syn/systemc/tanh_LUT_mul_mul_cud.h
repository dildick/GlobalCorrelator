...
#ifndef __tanh_LUT_mul_mul_cud__HH__
#define __tanh_LUT_mul_mul_cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(tanh_LUT_mul_mul_cud) {
    ...
    SC_CTOR(tanh_LUT_mul_mul_cud):  ACMP_mul_us_U ("ACMP_mul_us_U") {
