set C_TypeInfoList {{ 
"tanh_LUT<ap_fixed<14, 4, (ap_q_mode)5, (ap_o_mode)3, 0>, ap_fixed<14, 4, (ap_q_mode)5, (ap_o_mode)3, 0> >" : [[{"data_T":[[],"0"]},{"res_T":[[],"0"]}], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"data": [[], {"reference": "0"}] }, {"res": [[], {"reference": "0"}] }],[],""], 
...
"0": [ "ap_fixed<14, 4, 5, 3, 0>", {"hls_type": {"ap_fixed": [[[[], {"scalar": { "int": 14}}],[[], {"scalar": { "int": 4}}],[[], {"scalar": { "1": 5}}],[[], {"scalar": { "2": 3}}],[[], {"scalar": { "int": 0}}]],""]}}]
}}
set moduleName tanh_LUT
...
set C_modelName {tanh_LUT<ap_fixed<14, 4, (ap_q_mode)5, (ap_o_mode)3, 0>, ap_fixed<14, 4, (ap_q_mode)5, (ap_o_mode)3, 0>, 8192>}
set C_modelType { void 0 }
set C_modelArgList {
	{ data_V int 14 regular {pointer 0}  }
	{ res_V int 14 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "data_V", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY", "bitSlice":[{"low":0,"up":13,"cElement": [{"cName": "data.V","cData": "int14","bit_use": { "low": 0,"up": 13},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
...
set portList { 
	...
	{ data_V sc_in sc_lv 14 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "data_V", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "data_V", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.tanh_LUT_mul_mul_cud_U1", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	data_V { ap_none {  { data_V in_data 0 14 } } }
