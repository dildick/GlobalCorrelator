...
set out_width 28
set exp i0*i1
set arg_lists {i0 {14 1 +} i1 {14 1 +} p {28 1 +} }
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mul] == "ap_gen_simcore_mul"} {
eval "ap_gen_simcore_mul { \
    id ${id} \
...
eval "cg_default_interface_gen_dc { \
    id 32 \
    name inTrack_hwPropEta_V \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_inTrack_hwPropEta_V \
    op interface \
    ports { inTrack_hwPropEta_V { I 14 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 33 \
    name inTrack_hwPropPhi_V \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_inTrack_hwPropPhi_V \
    op interface \
    ports { inTrack_hwPropPhi_V { I 23 vector } } \
} "
}
