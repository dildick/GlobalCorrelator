...
#ifndef __match_prop_hw_sitfYi__HH__
#define __match_prop_hw_sitfYi__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(match_prop_hw_sitfYi) {
    ...
    SC_CTOR(match_prop_hw_sitfYi):  ACMP_sitodp_U ("ACMP_sitodp_U") {
