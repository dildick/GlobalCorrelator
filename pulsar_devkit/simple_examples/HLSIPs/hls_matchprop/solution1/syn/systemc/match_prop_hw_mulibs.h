...
#ifndef __match_prop_hw_mulibs__HH__
#define __match_prop_hw_mulibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(match_prop_hw_mulibs) {
    ...
    SC_CTOR(match_prop_hw_mulibs):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
