...
#ifndef __match_prop_hw_mulhbi__HH__
#define __match_prop_hw_mulhbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(match_prop_hw_mulhbi) {
    ...
    SC_CTOR(match_prop_hw_mulhbi):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
