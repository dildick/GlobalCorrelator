...
architecture behav of arcsinh is 
    ...
    "arcsinh,hls_ip_2016_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7vx690tffg1927-2,HLS_INPUT_CLOCK=4.115000,HLS_INPUT_ARCH=pipeline,HLS_SYN_CLOCK=3.490000,HLS_SYN_LAT=6,HLS_SYN_TPT=1,HLS_SYN_MEM=6,HLS_SYN_DSP=1,HLS_SYN_FF=94,HLS_SYN_LUT=114}";
    ...
    signal tmp_8_reg_271 : STD_LOGIC_VECTOR (12 downto 0);
    signal ap_pipeline_reg_pp0_iter3_tmp_8_reg_271 : STD_LOGIC_VECTOR (12 downto 0);
    ...
    signal sel_tmp_fu_221_p3 : STD_LOGIC_VECTOR (11 downto 0);
    signal storemerge1_fu_234_p3 : STD_LOGIC_VECTOR (11 downto 0);
    signal grp_fu_247_p0 : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_NS_fsm : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_pipeline_idle_pp0 : STD_LOGIC;

    component arcsinh_mul_mul_1cud IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    ...
    arcsinh_mul_mul_1cud_U1 : component arcsinh_mul_mul_1cud
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 16,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_const_logic_1 = ap_enable_reg_pp0_iter0) and (ap_start = ap_const_logic_0))) and not((ap_pipeline_reg_pp0_iter2_tmp_6_reg_260 = ap_const_lv1_0)))) then
                tmp_7_reg_276 <= neg_mul_fu_117_p2(28 downto 17);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_const_logic_1 = ap_enable_reg_pp0_iter0) and (ap_start = ap_const_logic_0))) and (ap_pipeline_reg_pp0_iter1_tmp_6_reg_260 = ap_const_lv1_0))) then
                tmp_8_reg_271 <= grp_fu_247_p2(29 downto 17);
            end if;
        end if;
    end process;
    ...
    arcsinh_table1_address0 <= tmp_3_fu_206_p1(13 - 1 downto 0);
    ...
    sel_tmp_fu_221_p3 <= 
        ap_const_lv12_0 when (sel_tmp2_fu_216_p2(0) = '1') else 
        ap_const_lv12_9F7;
    storemerge1_fu_234_p3 <= 
        sel_tmp_fu_221_p3 when (tmp_4_fu_229_p2(0) = '1') else 
        arcsinh_table1_q0;
