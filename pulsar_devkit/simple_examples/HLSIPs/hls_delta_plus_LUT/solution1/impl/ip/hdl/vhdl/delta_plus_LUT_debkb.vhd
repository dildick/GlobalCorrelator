...
entity delta_plus_LUT_debkb_rom is 
    generic(
             dwidth     : integer := 5; 
             awidth     : integer := 10; 
...
architecture rtl of delta_plus_LUT_debkb_rom is 
...
entity delta_plus_LUT_debkb is
    generic (
        DataWidth : INTEGER := 5;
...
architecture arch of delta_plus_LUT_debkb is
    component delta_plus_LUT_debkb_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    delta_plus_LUT_debkb_rom_U :  component delta_plus_LUT_debkb_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
