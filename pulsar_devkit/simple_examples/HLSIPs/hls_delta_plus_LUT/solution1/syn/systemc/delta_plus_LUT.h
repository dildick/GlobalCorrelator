...
#include "delta_plus_LUT_mucud.h"
#include "delta_plus_LUT_debkb.h"
...
struct delta_plus_LUT : public sc_module {
    ...
    delta_plus_LUT_debkb* delta_plus_table1_U;
    delta_plus_LUT_mucud<1,3,13,11,24>* delta_plus_LUT_mucud_U1;
    ...
    sc_signal< sc_lv<10> > delta_plus_table1_address0;
    sc_signal< sc_logic > delta_plus_table1_ce0;
    sc_signal< sc_lv<5> > delta_plus_table1_q0;
    ...
    void thread_delta_plus_table1_address0();
    void thread_delta_plus_table1_ce0();
