...
#ifndef __delta_plus_LUT_mucud__HH__
#define __delta_plus_LUT_mucud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(delta_plus_LUT_mucud) {
    ...
    SC_CTOR(delta_plus_LUT_mucud):  ACMP_mul_us_U ("ACMP_mul_us_U") {
