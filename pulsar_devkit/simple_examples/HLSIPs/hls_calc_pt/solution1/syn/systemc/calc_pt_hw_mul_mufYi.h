...
#ifndef __calc_pt_hw_mul_mufYi__HH__
#define __calc_pt_hw_mul_mufYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(calc_pt_hw_mul_mufYi) {
    ...
    SC_CTOR(calc_pt_hw_mul_mufYi):  ACMP_mul_us_U ("ACMP_mul_us_U") {
