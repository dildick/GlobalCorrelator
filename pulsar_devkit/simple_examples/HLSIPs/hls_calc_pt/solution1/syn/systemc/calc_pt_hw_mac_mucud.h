...
#ifndef __calc_pt_hw_mac_mucud__HH__
#define __calc_pt_hw_mac_mucud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(calc_pt_hw_mac_mucud) {
    ...
    SC_CTOR(calc_pt_hw_mac_mucud):  simcore_mac_0_U ("simcore_mac_0_U") {
