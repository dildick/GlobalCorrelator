...
#ifndef __calc_pt_hw_sitodpeOg__HH__
#define __calc_pt_hw_sitodpeOg__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(calc_pt_hw_sitodpeOg) {
    ...
    SC_CTOR(calc_pt_hw_sitodpeOg):  ACMP_sitodp_U ("ACMP_sitodp_U") {
