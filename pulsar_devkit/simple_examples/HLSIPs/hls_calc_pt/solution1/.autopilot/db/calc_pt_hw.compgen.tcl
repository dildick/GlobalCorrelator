...
set out_width 27
set exp i0*i1
set arg_lists {i0 {13 0 +} i1 {14 1 +} p {27 1 +} }
if {${::AESL::PGuard_simmodel_gen}} {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_hwRinv_V \
    op interface \
    ports { hwRinv_V { I 15 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_outPt_V \
    op interface \
    ports { outPt_V { O 14 vector } outPt_V_ap_vld { O 1 bit } } \
} "
}
