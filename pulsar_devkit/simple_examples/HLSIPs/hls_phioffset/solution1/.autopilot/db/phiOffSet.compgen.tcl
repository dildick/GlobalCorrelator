...
set ID 4
set MemName phiOffSet_phiOffSbkb
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sector_V \
    op interface \
    ports { sector_V { I 33 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { result_V { O 19 vector } result_V_ap_vld { O 1 bit } } \
} "
}
