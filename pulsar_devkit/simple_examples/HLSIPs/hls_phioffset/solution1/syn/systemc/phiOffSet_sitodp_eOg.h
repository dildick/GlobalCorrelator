...
#ifndef __phiOffSet_sitodp_eOg__HH__
#define __phiOffSet_sitodp_eOg__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(phiOffSet_sitodp_eOg) {
    ...
    SC_CTOR(phiOffSet_sitodp_eOg):  ACMP_sitodp_U ("ACMP_sitodp_U") {
