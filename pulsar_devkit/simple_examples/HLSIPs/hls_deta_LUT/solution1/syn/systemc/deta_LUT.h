...
#include "deta_LUT_mul_mul_cud.h"
#include "deta_LUT_deta_tabbkb.h"
...
struct deta_LUT : public sc_module {
    ...
    deta_LUT_deta_tabbkb* deta_table1_U;
    deta_LUT_mul_mul_cud<1,3,13,11,24>* deta_LUT_mul_mul_cud_U1;
    ...
    sc_signal< sc_lv<10> > deta_table1_address0;
    sc_signal< sc_logic > deta_table1_ce0;
    sc_signal< sc_lv<5> > deta_table1_q0;
    ...
    sc_signal< sc_lv<5> > sel_tmp_cast_fu_223_p3;
    ...
    void thread_deta_table1_address0();
    void thread_deta_table1_ce0();
    ...
    void thread_sel_tmp_cast_fu_223_p3();
