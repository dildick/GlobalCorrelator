...
#ifndef __deta_LUT_deta_tabbkb_H__
#define __deta_LUT_deta_tabbkb_H__
...
struct deta_LUT_deta_tabbkb_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(deta_LUT_deta_tabbkb_ram) {
...
SC_MODULE(deta_LUT_deta_tabbkb) {
...
deta_LUT_deta_tabbkb_ram* meminst;


SC_CTOR(deta_LUT_deta_tabbkb) {
meminst = new deta_LUT_deta_tabbkb_ram("deta_LUT_deta_tabbkb_ram");
