...
architecture behav of delta_LUT is 
    ...
    signal tmp_270_reg_307 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_pipeline_reg_pp0_iter1_tmp_270_reg_307 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_pipeline_reg_pp0_iter2_tmp_270_reg_307 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_pipeline_reg_pp0_iter3_tmp_270_reg_307 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_pipeline_reg_pp0_iter4_tmp_270_reg_307 : STD_LOGIC_VECTOR (0 downto 0);
    signal p_v_fu_152_p3 : STD_LOGIC_VECTOR (21 downto 0);
    signal p_v_reg_313 : STD_LOGIC_VECTOR (21 downto 0);
    signal tmp_273_fu_159_p1 : STD_LOGIC_VECTOR (18 downto 0);
    signal tmp_273_reg_318 : STD_LOGIC_VECTOR (18 downto 0);
    signal r_V_19_fu_178_p2 : STD_LOGIC_VECTOR (18 downto 0);
    signal r_V_19_reg_323 : STD_LOGIC_VECTOR (18 downto 0);
    signal tmp_210_fu_184_p4 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_210_reg_328 : STD_LOGIC_VECTOR (12 downto 0);
    ...
    signal tmp_277_reg_343 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_fu_260_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_reg_349 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_208_fu_266_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal tmp_269_fu_114_p1 : STD_LOGIC_VECTOR (42 downto 0);
    signal neg_mul_fu_118_p2 : STD_LOGIC_VECTOR (42 downto 0);
    signal tmp_271_fu_124_p4 : STD_LOGIC_VECTOR (17 downto 0);
    signal tmp_272_fu_138_p4 : STD_LOGIC_VECTOR (18 downto 0);
    signal tmp_fu_134_p1 : STD_LOGIC_VECTOR (21 downto 0);
    signal tmp_219_fu_148_p1 : STD_LOGIC_VECTOR (21 downto 0);
    signal neg_ti_fu_163_p2 : STD_LOGIC_VECTOR (18 downto 0);
    signal tmp_274_fu_168_p1 : STD_LOGIC_VECTOR (18 downto 0);
    signal tmp_220_fu_171_p3 : STD_LOGIC_VECTOR (18 downto 0);
    signal tmp_276_fu_198_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal ret_V_cast_fu_194_p1 : STD_LOGIC_VECTOR (13 downto 0);
    signal tmp_221_fu_221_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_222_fu_224_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_275_fu_214_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_223_fu_227_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal index_fu_234_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_278_fu_250_p4 : STD_LOGIC_VECTOR (21 downto 0);
    signal sel_tmp1_fu_271_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal sel_tmp2_fu_276_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_212_fu_289_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal sel_tmp_fu_281_p3 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    component delta_LUT_delta_tdEe IS
    generic (
        DataWidth : INTEGER;
...
begin
    delta_table5_U : component delta_LUT_delta_tdEe
    generic map (
        DataWidth => 11,
        AddressRange => 1024,
        AddressWidth => 10)
    ...
    tkmu_simple_hw_mueOg_U4 : component tkmu_simple_hw_mueOg
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 23,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_CS_fsm_pp0_stage0 = ap_const_lv1_1) and not(((ap_const_logic_1 = ap_enable_reg_pp0_iter0) and (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_ce))) then
                ap_pipeline_reg_pp0_iter1_tmp_270_reg_307 <= tmp_270_reg_307;
                tmp_270_reg_307 <= data_V_read(10 downto 10);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_const_logic_1 = ap_enable_reg_pp0_iter0) and (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_ce))) then
                ap_pipeline_reg_pp0_iter2_tmp_270_reg_307 <= ap_pipeline_reg_pp0_iter1_tmp_270_reg_307;
                ap_pipeline_reg_pp0_iter3_tmp_270_reg_307 <= ap_pipeline_reg_pp0_iter2_tmp_270_reg_307;
                ap_pipeline_reg_pp0_iter4_tmp_270_reg_307 <= ap_pipeline_reg_pp0_iter3_tmp_270_reg_307;
                icmp_reg_349 <= icmp_fu_260_p2;
                p_v_reg_313 <= p_v_fu_152_p3;
                r_V_19_reg_323 <= r_V_19_fu_178_p2;
                ret_V_reg_338 <= ret_V_fu_208_p2;
                tmp_210_reg_328 <= r_V_19_fu_178_p2(18 downto 6);
                tmp_277_reg_343 <= index_fu_234_p3(31 downto 31);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_const_logic_1 = ap_enable_reg_pp0_iter0) and (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_ce) and not((ap_pipeline_reg_pp0_iter3_tmp_270_reg_307 = ap_const_lv1_0)))) then
                tmp_273_reg_318 <= tmp_273_fu_159_p1;
            end if;
        end if;
    end process;
    ...
    ap_return <= 
        sel_tmp_fu_281_p3 when (tmp_212_fu_289_p2(0) = '1') else 
        delta_table5_q0;
    delta_table5_address0 <= tmp_208_fu_266_p1(10 - 1 downto 0);

    delta_table5_ce0_assign_proc : process(ap_start, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter6, ap_ce)
    begin
    ...
    icmp_fu_260_p2 <= "1" when (signed(tmp_278_fu_250_p4) > signed(ap_const_lv22_0)) else "0";
    index_fu_234_p3 <= 
        tmp_223_fu_227_p3 when (tmp_275_fu_214_p3(0) = '1') else 
        tmp_221_fu_221_p1;
    neg_mul_fu_118_p2 <= std_logic_vector(unsigned(ap_const_lv43_0) - unsigned(tmp_269_fu_114_p1));
    neg_ti_fu_163_p2 <= std_logic_vector(unsigned(ap_const_lv19_0) - unsigned(tmp_273_reg_318));
    p_v_fu_152_p3 <= 
        tmp_fu_134_p1 when (ap_pipeline_reg_pp0_iter3_tmp_270_reg_307(0) = '1') else 
        tmp_219_fu_148_p1;
    r_V_19_fu_178_p2 <= std_logic_vector(unsigned(ap_const_lv19_10000) - unsigned(tmp_220_fu_171_p3));
    r_V_fu_88_p3 <= (data_V_read & ap_const_lv10_0);
        ret_V_cast_fu_194_p1 <= std_logic_vector(resize(signed(tmp_210_fu_184_p4),14));

    ret_V_fu_208_p2 <= std_logic_vector(unsigned(ap_const_lv14_1) + unsigned(ret_V_cast_fu_194_p1));
    sel_tmp1_fu_271_p2 <= (tmp_277_reg_343 xor ap_const_lv1_1);
    sel_tmp2_fu_276_p2 <= (icmp_reg_349 and sel_tmp1_fu_271_p2);
    sel_tmp_fu_281_p3 <= 
        ap_const_lv11_0 when (sel_tmp2_fu_276_p2(0) = '1') else 
        ap_const_lv11_483;
    tmp_208_fu_266_p1 <= std_logic_vector(resize(unsigned(index_fu_234_p3),64));
    tmp_210_fu_184_p4 <= r_V_19_fu_178_p2(18 downto 6);
    tmp_212_fu_289_p2 <= (sel_tmp2_fu_276_p2 or tmp_277_reg_343);
        tmp_219_fu_148_p1 <= std_logic_vector(resize(signed(tmp_272_fu_138_p4),22));

    tmp_220_fu_171_p3 <= 
        neg_ti_fu_163_p2 when (ap_pipeline_reg_pp0_iter4_tmp_270_reg_307(0) = '1') else 
        tmp_274_fu_168_p1;
        tmp_221_fu_221_p1 <= std_logic_vector(resize(signed(tmp_210_reg_328),32));

        tmp_222_fu_224_p1 <= std_logic_vector(resize(signed(ret_V_reg_338),32));

    tmp_223_fu_227_p3 <= 
        tmp_221_fu_221_p1 when (tmp_s_reg_333(0) = '1') else 
        tmp_222_fu_224_p1;
    tmp_269_fu_114_p1 <= grp_fu_100_p2(43 - 1 downto 0);
    tmp_271_fu_124_p4 <= neg_mul_fu_118_p2(42 downto 25);
    tmp_272_fu_138_p4 <= grp_fu_100_p2(43 downto 25);
    tmp_273_fu_159_p1 <= p_v_fu_152_p3(19 - 1 downto 0);
    tmp_274_fu_168_p1 <= p_v_reg_313(19 - 1 downto 0);
    tmp_275_fu_214_p3 <= r_V_19_reg_323(18 downto 18);
    tmp_276_fu_198_p1 <= r_V_19_fu_178_p2(6 - 1 downto 0);
    tmp_278_fu_250_p4 <= index_fu_234_p3(31 downto 10);
        tmp_fu_134_p1 <= std_logic_vector(resize(signed(tmp_271_fu_124_p4),22));

    tmp_s_fu_202_p2 <= "1" when (tmp_276_fu_198_p1 = ap_const_lv6_0) else "0";
end behav;
