...
#ifndef __tkmu_simple_hw_matde__HH__
#define __tkmu_simple_hw_matde__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(tkmu_simple_hw_matde) {
    ...
    SC_CTOR(tkmu_simple_hw_matde):  simcore_mac_0_U ("simcore_mac_0_U") {
