...
#ifndef __tkmu_simple_hw_sincg__HH__
#define __tkmu_simple_hw_sincg__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(tkmu_simple_hw_sincg) {
    ...
    SC_CTOR(tkmu_simple_hw_sincg):  ACMP_sitodp_U ("ACMP_sitodp_U") {
