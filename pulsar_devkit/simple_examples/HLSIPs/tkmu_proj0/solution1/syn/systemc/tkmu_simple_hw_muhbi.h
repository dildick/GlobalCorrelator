...
#ifndef __tkmu_simple_hw_muhbi__HH__
#define __tkmu_simple_hw_muhbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(tkmu_simple_hw_muhbi) {
    ...
    SC_CTOR(tkmu_simple_hw_muhbi):  ACMP_mul_us_U ("ACMP_mul_us_U") {
