...
#ifndef __tkmu_simple_hw_muudo__HH__
#define __tkmu_simple_hw_muudo__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(tkmu_simple_hw_muudo) {
    ...
    SC_CTOR(tkmu_simple_hw_muudo):  ACMP_smul_su_U ("ACMP_smul_su_U") {
