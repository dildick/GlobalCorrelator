...
#ifndef __tkmu_simple_hw_mucud__HH__
#define __tkmu_simple_hw_mucud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(tkmu_simple_hw_mucud) {
    ...
    SC_CTOR(tkmu_simple_hw_mucud):  ACMP_mul_us_U ("ACMP_mul_us_U") {
