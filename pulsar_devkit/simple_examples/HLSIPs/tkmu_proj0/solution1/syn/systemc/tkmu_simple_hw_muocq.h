...
#ifndef __tkmu_simple_hw_muocq__HH__
#define __tkmu_simple_hw_muocq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(tkmu_simple_hw_muocq) {
    ...
    SC_CTOR(tkmu_simple_hw_muocq):  ACMP_mul_su_U ("ACMP_mul_su_U") {
