...
#ifndef __tkmu_simple_hw_muqcK__HH__
#define __tkmu_simple_hw_muqcK__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(tkmu_simple_hw_muqcK) {
    ...
    SC_CTOR(tkmu_simple_hw_muqcK):  ACMP_mul_su_U ("ACMP_mul_su_U") {
