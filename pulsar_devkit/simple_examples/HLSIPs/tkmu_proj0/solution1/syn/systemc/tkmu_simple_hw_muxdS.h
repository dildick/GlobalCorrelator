...
#ifndef __tkmu_simple_hw_muxdS__HH__
#define __tkmu_simple_hw_muxdS__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(tkmu_simple_hw_muxdS) {
    ...
    SC_CTOR(tkmu_simple_hw_muxdS):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
