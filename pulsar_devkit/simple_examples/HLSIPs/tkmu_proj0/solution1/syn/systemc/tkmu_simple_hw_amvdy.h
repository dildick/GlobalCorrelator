...
#ifndef __tkmu_simple_hw_amvdy__HH__
#define __tkmu_simple_hw_amvdy__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(tkmu_simple_hw_amvdy) {
    ...
    SC_CTOR(tkmu_simple_hw_amvdy):  simcore_am_0_U ("simcore_am_0_U") {
