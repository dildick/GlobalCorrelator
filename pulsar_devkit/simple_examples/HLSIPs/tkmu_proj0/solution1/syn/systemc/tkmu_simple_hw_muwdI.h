...
#ifndef __tkmu_simple_hw_muwdI__HH__
#define __tkmu_simple_hw_muwdI__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(tkmu_simple_hw_muwdI) {
    ...
    SC_CTOR(tkmu_simple_hw_muwdI):  ACMP_smul_us_U ("ACMP_smul_us_U") {
