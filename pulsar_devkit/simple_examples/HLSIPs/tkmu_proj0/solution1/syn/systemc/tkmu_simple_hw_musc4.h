...
#ifndef __tkmu_simple_hw_musc4__HH__
#define __tkmu_simple_hw_musc4__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(tkmu_simple_hw_musc4) {
    ...
    SC_CTOR(tkmu_simple_hw_musc4):  ACMP_smul_su_U ("ACMP_smul_su_U") {
