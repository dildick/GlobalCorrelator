...
#ifndef __tkmu_simple_hw_mukbM__HH__
#define __tkmu_simple_hw_mukbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(tkmu_simple_hw_mukbM) {
    ...
    SC_CTOR(tkmu_simple_hw_mukbM):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
